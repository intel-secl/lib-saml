...
# Intel<sup>®</sup> Security Libraries for Data Center  - SAML Library
...
## Key features
- Provides interface to produce and verify SAML report
...
- Git clone the `SAML Library`
- Run scripts to build the `SAML Library`

```shell
$ git clone https://github.com/intel-secl/lib-saml.git
$ cd lib-saml
$ ant
```
